...
----------------------------------
1. Check that you have the latest version of :code:`structuregraph_helpers`
2. Check that StackOverflow hasn't already solved your problem
3. Go here: https://github.com/kjappelbaum/structuregraph-helpers/issues
...
.. code-block:: sh
    ...
    $ git clone https://github.com/<YourUsername>/structuregraph-helpers
...
If you spend a while working on your changes, further commits may be made to the main :code:`structuregraph_helpers`
...
.. code-block:: sh
    ...
    $ git remote add upstream https://github.com/kjappelbaum/structuregraph-helpers
